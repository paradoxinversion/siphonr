...
class Tweet extends React.Component {
          ...
          <p>
            ...
            <a
              ...
              href={`https://twitter.com/intent/user?user_id=${
                this.props.tweet.in_reply_to_user_id_str
              }`}>
              {this.props.tweet.in_reply_to_screen_name}.
            </a>{" "}
          </p>
        </div>
      );
  ...
  renderMedia() {
    ...
    if (this.props.tweet.media) {
      ...
      mediaElement = <div className="tweet-media-container">{mediaItems}</div>;
    }
    return mediaElement;
  }
    ...
    return (
      <div className="tweet-metadata">
        <a
          ...
          target="_blank"
          href={`https://twitter.com/statuses/${this.props.tweet.id_str}`}>
          Thread
        </a>
        <p className="tweet-post-timestamp">
          {" "}
          Posted {this.props.tweet.created_at}{" "}
        </p>
      </div>
    );
  }
  ...
  renderTweet() {
    ...
    return (
      <div className="tweet">
        ...
        retweetElement ? (
          <div>
            <p className="tweet__retweeted-string">
              {this.props.user.name} Retweeted{" "}
            </p>
